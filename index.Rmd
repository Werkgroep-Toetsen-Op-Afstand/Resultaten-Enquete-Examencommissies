...
Dit rapport valt uiteen in drie hoofdstukken. In dit eerste hoofdstuk beschrijven we de voornaamste conclusies die getrokken kunnen worden op basis van de resultaten van de enquête. In [hoofdstuk 2](https://werkgroep-toetsen-op-afstand.github.io/Resultaten-Enquete-Examencommissies/enquêtevragen.html) geven we per enquêtevraag een samenvatting en geven we duiding aan de antwoorden op de betreffende vraag. [Hoofdstuk 3](https://werkgroep-toetsen-op-afstand.github.io/Resultaten-Enquete-Examencommissies/enquête-data.html) is gewijd aan de ruwe data: de door respondenten vrijgegeven antwoorden en de door hen geüploade documenten.
...
De handreikingen zullen beschikbaar gemaakt worden op de [website van de werkgroep](https://www.versnellingsplan.nl/werkgroep-toetsen-op-afstand/).
